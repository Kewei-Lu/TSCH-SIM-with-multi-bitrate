...
//callbacks[74880] = collect_stats;  // change period at asn = 8500 = 17 * 500
callbacks[74881] = change_period_8;  // @ 2200s
//callbacks[56924] = check_stats; 

//callbacks[159972] = collect_stats;
callbacks[159973] = change_period_12;  // @ 4700s
//callbacks[73426] = check_stats;

//callbacks[194009] = collect_stats;
callbacks[194010] = change_period_30;  // @5700s
//callbacks[74666] = check_stats;

//callbacks[245060] = collect_stats;  // raw original speed = 50kbps
callbacks[245060] = collect_stats; 
